...
```
## [Home](https://annettelewis.github.io/) | [Projects](https://annettelewis.github.io/projects/) | [Final Project](https://annettelewis.github.io/projects/BIOL_3100_final_project/)
...
Here is my [LinkedIn](https://www.linkedin.com/in/annette-lewis-68314b216/), my [resume](https://annettelewis.github.io/media/Annette_Lewis_Resume.pdf), and [CV](https://annettelewis.github.io/media/CV_Lewis.pdf)
...
Here is an example where I play around with the mpg (miles per gallon) dataset. 

This table can be scrolled through for additional information:
...
This following plot demonstrates displacement with the city. These data points are interactive:
```{r message=FALSE, include=TRUE}
p <- mpg %>% 
...
A more extensive project that I have done can be seen [here](https://annettelewis.github.io/projects/BIOL_3100_final_project/) where I looked at tornado building damage in New Orleans.
